...
if(div_id!="iframe"){
	...
	document.getElementById('info_block').innerHTML='<table border="0" cellpadding="0" cellspacing="0" width="230">'+
	...
	'<tr><td style="width:20px;"></td><td><div style="width:270px;height:150px;margin:0;padding:0;border-style:none;border-width:0;background-image:url('+imgpath+'loginform_bck.png);">'+
	...
	'<tr><td colspan="2" align="center"><br /><a style="color:#d5d5d5;text-decoration:none;font-weight:bold;" href="http://wpsells.com/links/uwcartstart/ectreg.html" target="_blank">Зарегистрировать Аккаунт</a></td><td style="width:20px;"></td></tr>'+
	'</table>';
}
else{
